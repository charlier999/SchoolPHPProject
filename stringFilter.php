<?php
/*
 *     FileName: stringFilter.php
 *     Date: 3/5/2020
 *     Author: Charles Davis
 *     
 *     Description:
 *     This code came from the websight
 *     http://www.bitrepository.com/advanced-word-filter.html
 *     and is only for testing and recreating it for use in the project
 *     !!!DO NOT USE!!!
 */
